									...
									<div class="con01_txt">　
										<div class="g-wrap">
											<div class="m-loginmain"> 
												<div class="main">
													<ul class="main-form">
														<li><span class="tit">帐号：</span><input id="username" name="name" tabindex="1" class="input_public" maxlength="32" type="text"><span class="onShow" style="margin: 0px; padding: 0px; background: none repeat scroll 0% 0% transparent;" id="usernameTip"></span><!-- <div class="tips">输入一个你已拥有的邮件地址作为帐号，以通过验证完成注册。</div> --></li>
														<li><span class="tit">密码：</span><input id="password" name="password" tabindex="2" class="input_public" maxlength="16" type="password"><span class="onShow" style="margin: 0px; padding: 0px; background: none repeat scroll 0% 0% transparent;" id="passwordTip"></span><!-- <div class="tips">6到16个字符，区分大小写。</div> --></li>
														<li><span class="tit">确认密码：</span><input id="pwdconfirm" name="pwdconfirm" tabindex="3" class="input_public" maxlength="16" type="password"><span class="onShow" style="margin: 0px; padding: 0px; background: none repeat scroll 0% 0% transparent;" id="pwdconfirmTip"></span><div class="tips">再次输入你设置的密码。</div></li>
													</ul>
													<div class="sub-area"><input id="submit" class="btn-blue" value="注册" type="submit"><span class="onShow" style="margin: 0px; padding: 0px; background: none repeat scroll 0% 0% transparent;" id="checkedTip"></span></div>
												</div>
											</div>
										</div>
									</div>
