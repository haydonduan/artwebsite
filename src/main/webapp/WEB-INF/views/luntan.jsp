    ...
    <!-- 导航头部 begin -->
	  ...
	  <div class="main clearfix">
	  	<div class="sub clearfix" id="sub01">
			<div class="sub_c">
				<!-- 论坛 -->
				<div class="sub_c5" id="sub_c5">
					<div class="sub_cmain">
						<div class="left" style="height:485px;">
							<div class="piclist">
								<ul>
									<li>
										<img src="${context}/files/U2104P31T32D110238F651DT20131122014106.jpg" width="380" height="230"><span class="tit" style="width:380px;">画家论坛</span>
									</li>
								</ul>
							</div>
							<br/>
							<div class="left">
								...
								<div class="con01" style="overflow: hidden; position: relative; height:400px;padding: 0px; ">
									<div class="jscroll-c" style="top: 0px; z-index: 9999; zoom: 1; position: relative; padding: 0px; ">
										...
										<div class="con01_txt">
											...
											<c:forEach items="${hotArticle}" var="hot">
												<li id="sub_t30" style="cursor:pointer" onclick="javascript:window.location.href='${context}/forum/${hot.id}'">【${hot.title} 】($<fmt:formatDate value="${hot.createTime}" pattern="yyyy-MM-dd  HH:mm:ss" />)</li>
											</c:forEach>
											</ul>
										</div>
									</div>
						...
						<div class="right" style="width:450px;">
							<div class="tit01">
								<h2 class="tr"><span id="sub_t40" style="font-size:12px; cursor:pointer;" onclick="window.location.href='${context}/forum/page/0'">更多&raquo;</span>&nbsp;&nbsp;&nbsp;&nbsp;最新帖子</h2>
							</div>
							<div class="con01" style="height:225px; overflow: hidden; position: relative; padding: 0px; ">
								<div class="jscroll-c" style="top: 0px; z-index: 9999; zoom: 1; position: relative; padding: 0px; ">
									<div style="height:0px;overflow:hidden"></div>
									<div class="con01_txt">
										<ul class="list">
											<c:forEach items="${newArticle}" var="new">
												<li id="sub_t30" style="cursor:pointer"  onclick="javascript:window.location.href='${context}/forum/${new.id}'">【${new.title}】(<fmt:formatDate value="${new.createTime}" pattern="yyyy-MM-dd  HH:mm:ss" />)</li>
											</c:forEach>
										</ul>
									</div>
								</div>
								<div class="jscroll-e" unselectable="on" style="height: 100%; top: 0px; right: 0px; position: absolute; overflow: hidden; z-index: 10000; width: 7px; background-color: rgb(224, 214, 194); display: none; background-position: initial initial; background-repeat: initial initial; ">
									<div class="jscroll-u" style="position: absolute; top: 0px; width: 100%; left: 0px; background-color: black; overflow: hidden; height: 0px; background-position: initial initial; background-repeat: initial initial; "></div>
									<div class="jscroll-h" unselectable="on" style="background-color:rgb(33,63,70); position: absolute; left: 0px; border: 1px solidrgb(33,63,70); top: 0px; width: 5px; height: 210.74561403508773px; background-position: initial initial; background-repeat: initial initial; "></div>
									<div class="jscroll-d" style="position: absolute; bottom: 0px; width: 100%; left: 0px; background-color: black; overflow: hidden; height: 0px; background-position: initial initial; background-repeat: initial initial; "></div>
								</div>
							</div>
						</div>
						<div class="right" style="width:450px;">
							<div class="tit01">
								<h2 class="tr"><span id="sub_t42" style="font-size:12px; cursor:pointer;"  onclick="window.location.href='${context}/forum/page/0'">更多&raquo;</span>&nbsp;&nbsp;&nbsp;&nbsp;最新回复</h2>
							</div>
							<div class="con01" style="height:200px; overflow: hidden; position: relative; padding: 0px; ">
								<div class="jscroll-c" style="top: 0px; z-index: 9999; zoom: 1; position: relative; padding: 0px; ">
									<div style="height:0px;overflow:hidden"></div>
									<div class="con01_txt">
										<ul class="list">
											<c:forEach items="${newCommentArticle}" var="comment">
												<li id="sub_t30" style="cursor:pointer" onclick="javascript:window.location.href='${context}/forum/${comment.id}'">【${comment.title}】(<fmt:formatDate value="${comment.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />)</li>
											</c:forEach>
										</ul>
									</div>
								</div>
