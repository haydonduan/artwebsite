    ...
    <!-- 导航头部 begin -->
	  ...
	  <div class="main clearfix">
	  	<div class="sub clearfix" id="sub01">
			<div class="sub_c">
<!-- 画家简介 -->
				<div class="sub_c2" id="sub_c2" style=" ">
					<div class="sub_cmain">
						<div class="left">
							<img src="${context}/${user.image}" height="455" width="351">
						</div>
						<div class="right">
							<div class="tit01">
								<h2>画家简介</h2>
							...
							<div class="con01" style="overflow: hidden; position: relative; padding: 0px; ">
								<div class="jscroll-c" style="top: 0px; z-index: 9999; zoom: 1; position: relative; padding-right: 7px; ">
									...
									<div class="con01_txt">&nbsp;&nbsp;${user.detail}</div>
								</div>
