				...
				<div class="sub_c4" id="sub_c4" >				
					<div class="sub_cmain">
						<div class="left">
							<div class="piclist">
								...
								<c:forEach items="${proList}" var="pro">
									<li>
										<a href="${context}/newsnotice/${pro.id}"><img src="${context}/${pro.image}" width="265" height="168"><span class="tit">${pro.title}</span></a>
									</li>
								</c:forEach>
								</ul>
							</div>
						...
						<div class="right" style="width:550px">
							<div class="tit01">
								<h2>画家与社会&nbsp;&nbsp;&nbsp;&nbsp;<span id="sub_t39" style="font-size:12px; cursor:pointer;"  onclick="window.location.href='${context}/newsnotice/more/0/0'">更多&raquo;</span></h2>
							</div>
