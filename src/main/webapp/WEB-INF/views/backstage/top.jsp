...
<link href="${context}/skin/css/base.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="${context}/backstagejs/top.js"></script>
...
{
  text-align:center;
	background:url(${context}/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
.rmain {
  padding-left:10px;
  /* background:url(${context}/skin/images/frame/toprightbg.gif) no-repeat; */
}
</style>
</head>
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="${context}/skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="${context}/skin/images/frame/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span class="username">${sessionScope.SESSION_ADMIN_USER.name}</span>，欢迎使用内容管理系统！
        	[<a href="${context}" target="_blank">网站主页</a>]
        	[<a  target="_top" id="logout" style="cursor:pointer">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
        <td align="right" height="34" class="rmain">
		<dl id="tpa">
		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="#" onclick="changeSel(1)" target="main">操作区</a></div></dd>
		</dl>
		</td>
      </tr>
    </table></td>
